...
namespace URPShaderTestBed.Terrain
{
    class CustomTerrainShaderGUI : ShaderGUI, ITerrainLayerCustomUI
    {
        private class StylesLayer
        {
            ...
            public readonly GUIContent opacityDensityStrength = new GUIContent("Opacity As Density Strength");
        ...
        public CustomTerrainShaderGUI()
        {
        }

        // Custom Properties
        private MaterialProperty opacityDensityStrength = null;
        private const string kOpacityDensityStrength = "_OpacityDensityControlStrength";
        ...
        {
            opacityDensityStrength = FindProperty(kOpacityDensityStrength, props, false);
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            if (opacityDensityStrength != null)
            {
                EditorGUI.indentLevel++;
                EditorGUI.BeginChangeCheck();
                materialEditorIn.ShaderProperty(opacityDensityStrength, styles.opacityDensityStrength);
                EditorGUI.indentLevel--;
            }
        ...
        bool ITerrainLayerCustomUI.OnTerrainLayerGUI(TerrainLayer terrainLayer, UnityEngine.Terrain terrain)
        {
